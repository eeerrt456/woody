...
def main():
    ...
    with tab1:
        ...
        st.markdown("""
        <div class='info-box'>
            📤 Drag and drop your images here, or click to browse. Supports PNG, JPG, and JPEG formats.
        </div>
        """, unsafe_allow_html=True)
        
        # Enhanced file uploader with multiple file support
        uploaded_files = st.file_uploader(
            "Choose image(s)...",
            type=['png', 'jpg', 'jpeg'],
            help="Upload one or more clear images of wood or furniture",
            ...
            for idx, uploaded_file in enumerate(uploaded_files):
                ...
                if detections:
                    ...
                    if detections:
                        ...
                        <div class='stat-box'>
                            <div class='stat-number'>{max_conf*100:.1f}%</div>
                    ...
                    # Individual detections in expandable sections
                    with st.expander(f"View {len(detections)} detection(s) details", expanded=len(uploaded_files) == 1):
                    ...
                    st.markdown("""
                    <div class='info-box'>
                        ℹ️ No objects detected in this image. Try adjusting the confidence threshold or upload a different image.
                    </div>
                    """, unsafe_allow_html=True)
        else:
            st.markdown("""
            <div style='text-align: center; padding: 3rem; background: white; border-radius: 15px; border: 2px dashed #8B4513;'>
                <h3 style='color: #8B4513;'>👆 Upload your images above to get started</h3>
                <p style='color: #666; font-family: Lora, serif;'>Woody will analyze your images and detect wood types and furniture</p>
            </div>
            """, unsafe_allow_html=True)
